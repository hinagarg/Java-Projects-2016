...
public class PrimaryEducation extends AbstractPortal {
	...
	public PrimaryEducation(int projectId, String projectDescription, int projectCost, int amountCollected,
			int amountPending) {
		super();
